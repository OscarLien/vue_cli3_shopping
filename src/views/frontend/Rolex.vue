  ...
  <div>
    <div class="container">
      <div class="row justify-content-center">
        ...
        ></div>
        <div class="col-12">
          <h1 class="text-center py-3">關於Rolex</h1>
        </div>
        <div class="col-8">
          <div class="d-flex flex-column">
            <h2 class="brand-title mt-3">品牌簡介</h2>
            <p class="brand-text">
              勞力士（ Rolex ）是瑞士著名的手錶製造商，前身為 Wilsdorf and
              Davis（ W&D ） 公司， 由德國人漢斯·威斯多夫（ Hans Wilsdof
              ）與英國人戴維斯（ Alfred Davis ）於1905年在倫敦合夥經營。
              1908年由漢斯·威斯多夫在瑞士的拉夏德芬（ La Chaux-de-Fonds
              ）註冊更名為 ROLEX
              。勞力士以莊重、實用、不顯浮華的風格廣受成功人士喜愛，其錶款高度精準且具備超高的耐用度，在鐘錶圈中，
              勞力士的愛好者們常常會用一句話來形容勞力士：一“勞”永逸。
            </p>
            <h2 class="brand-title mt-3">品牌故事</h2>
            <p class="brand-text">
              勞力士的發展史與其富有遠見和開拓精神的創辦人漢斯・威爾斯多夫（
              Hans Wilsdorf ）之間，有著密不可分的關係。
